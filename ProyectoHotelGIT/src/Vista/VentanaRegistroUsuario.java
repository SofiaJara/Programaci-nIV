...
public class VentanaRegistroUsuario extends javax.swing.JFrame {
    ...
    private void registraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registraActionPerformed
        ...
        bool = Usuarios.confirmarContrasena(Cont, ConfirmacionCont);
        ...
        if(!bool){
           ...
           Usuarios.registrarUsuario(TipoIdentificacion, NumeroIdentificacion, Nombres, Apellidos, CorreoElectronico, DireccionResidencia, Telefono,Cont, CiudadResidencia); 
